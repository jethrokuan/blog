...
of my mind. Topic models such as [[https://en.wikipedia.org/wiki/Latent_Dirichlet_allocation][Latent Dirichlet Allocation]] (on which
[[https://github.com/jethrokuan/lda-survey][I spent a year researching on]]) could compute topics and their topical
