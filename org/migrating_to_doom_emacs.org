...
For reference, here is [[github:jethrokuan/.emacs.d][my original .emacs.d]] (now archived), and my current configuration lives in my [[github:jethrokuan/dots][home git repository]].
...
1. Doom uses [[github:raxod502/straight.el][straight.el]] to manage packages, which was also my practice
2. Doom uses [[github:jwiegley/use-package][use-package]] heavily, and so do I

This made the migration seem less daunting . Using Doom has brought me these benefits:

1. Doom starts up really quickly, which means less waiting time. This is especially important for me because I use [[github:ch11ng/exwm][exwm]], and the time Emacs loads is the time I can start using my computer.
