...
I recently decided to start doing more self-tracking. In my [[file:org_mode_workflow_preview.org][Org-mode workflow]]
...
2. Binary: Org-mode's support for habit-tracking is limited to binary actions
   ...
   tooling]]. Creating log entries need to be low friction.
